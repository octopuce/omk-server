...
$settings=array(
     "1" => array(
          ...
          "size_169" => "426x240",
          "cardinality" => "1",
          "command1" => "avconv -i %%SOURCE%% -acodec libmp3lame -vcodec flv -ar 44100 -ab 64k -b 280k -s %%SIZE%% %%DESTINATION%%.flv",
     ...
     "2" => array(
          ...
          "size_169" => "640x360",
          "cardinality" => "1",
          "command1" => "avconv -i %%SOURCE%% -acodec libmp3lame -vcodec flv -ar 44100 -ab 128k -b 440k -s %%SIZE%% %%DESTINATION%%.flv",
          "cancelcommand" => "rm %%DESTINATION%%.flv",
        ),
     ...
     "11" => array(
          ...
          "size_169" => "426x240",
          "cardinality" => "1",
          "command1" => "avconv -y -v info -i %%SOURCE%% -pass 1 -s %%SIZE%% -codec:v libx264 -b:v 512k -maxrate:v 800k -bufsize 10M -profile:v baseline -strict experimental -f rawvideo -acodec copy /dev/null",
          "command2" => "avconv -y -v info -i %%SOURCE%% -pass 2 -s %%SIZE%% -codec:v libx264 -b:v 512k -maxrate:v 800k -bufsize 10M -profile:v baseline -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 96k %%DESTINATION%%.tmp.mp4",
	  "command3" => "qt-faststart %%DESTINATION%%.tmp.mp4 %%DESTINATION%%.tmp.mp4",
     ...
     "12" => array(
          ...
          "size_169" => "640x360",
          "cardinality" => "1",
          "command1" => "avconv -y -v info -i %%SOURCE%% -pass 1 -s %%SIZE%% -codec:v libx264 -b:v 800k -maxrate:v 2M -bufsize 20M -profile:v main -strict experimental -f rawvideo -acodec copy /dev/null",
          "command2" => "avconv -y -v info -i %%SOURCE%% -pass 2 -s %%SIZE%% -codec:v libx264 -b:v 800k -maxrate:v 2M -bufsize 20M -profile:v main -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 128k %%DESTINATION%%.tmp.mp4",
	  "command3" => "qt-faststart %%DESTINATION%%.tmp.mp4 %%DESTINATION%%.tmp.mp4",
	  "command4" => "rm -f %%DESTINATION%%.tmp.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.mp4",
        ),
     ...
     "13" => array(
          ...
          "size_169" => "854x480",
          "cardinality" => "1",
          "command1" => "avconv -y -v info -i %%SOURCE%% -pass 1 -s %%SIZE%% -codec:v libx264 -b:v 2M -maxrate:v 4M -bufsize 30M -profile:v main -strict experimental -f rawvideo -acodec copy /dev/null",
          "command2" => "avconv -y -v info -i %%SOURCE%% -pass 2 -s %%SIZE%% -codec:v libx264 -b:v 2M -maxrate:v 4M -bufsize 30M -profile:v main -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 128k %%DESTINATION%%.tmp.mp4",
	  "command3" => "qt-faststart %%DESTINATION%%.tmp.mp4 %%DESTINATION%%.tmp.mp4",
	  "command4" => "rm -f %%DESTINATION%%.tmp.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.mp4",
        ),
     ...
     "14" => array(
          ...
          "size_169" => "1280x720",
          "cardinality" => "1",
          "command1" => "avconv -y -v info -i %%SOURCE%% -pass 1 -s %%SIZE%% -codec:v libx264 -b:v 4M -maxrate:v 8M -bufsize 40M -profile:v main -strict experimental -f rawvideo -acodec copy /dev/null",
          "command2" => "avconv -y -v info -i %%SOURCE%% -pass 2 -s %%SIZE%% -codec:v libx264 -b:v 4M -maxrate:v 8M -bufsize 40M -profile:v main -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 192k %%DESTINATION%%.tmp.mp4",
	  "command3" => "qt-faststart %%DESTINATION%%.tmp.mp4 %%DESTINATION%%.tmp.mp4",
	  "command4" => "rm -f %%DESTINATION%%.tmp.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.mp4",
        ),
     ...
     "15" => array(
          ...
          "size_169" => "1920x1080",
          "cardinality" => "1",
          "command1" => "avconv -y -v info -i %%SOURCE%% -pass 1 -s %%SIZE%% -codec:v libx264 -b:v 8M -maxrate:v 12M -bufsize 80M -profile:v main -strict experimental -f rawvideo -acodec copy /dev/null",
          "command2" => "avconv -y -v info -i %%SOURCE%% -pass 2 -s %%SIZE%% -codec:v libx264 -b:v 8M -maxrate:v 12M -bufsize 80M -profile:v main -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 192k %%DESTINATION%%.tmp.mp4",
	  "command3" => "qt-faststart %%DESTINATION%%.tmp.mp4 %%DESTINATION%%.tmp.mp4",
	  "command4" => "rm -f %%DESTINATION%%.tmp.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.mp4",
        ),
     ...
     "21" => array(
          ...
          "size_169" => "426x240",
          "cardinality" => "1",
          "command1" => "avconv -i %%SOURCE%% -acodec libvorbis -vcodec libvpx -ar 44100 -b:a 64k -b:v 280k -s %%SIZE%% %%DESTINATION%%.webm",
     ...
     "22" => array(
          ...
          "size_169" => "640x360",
          "cardinality" => "1",
          "command1" => "avconv -i %%SOURCE%% -acodec libvorbis -vcodec libvpx -ar 44100 -b:a 128k -b:v 440k -s %%SIZE%% %%DESTINATION%%.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.webm",
        ),
