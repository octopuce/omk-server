...
$settings=array(
     ...
     "11" => array(
          ...
          "technical" => "mp4 container, single-pass h264 video baseline coding, between 512 and 800kbps, aac audio at 96kbps and 44KHz, 426x240 pixels on 16:9, 25fps",
          "extension" => "mp4",
          "recommend" => "1",
          "size_43" => "320x240",
          "size_169" => "426x240",
          "cardinality" => "1",
          "command1" => "avconv -y -v info -i %%SOURCE%% -s %%SIZE%% -codec:v libx264 -pix_fmt:v yuv420p -b:v 512k -maxrate:v 800k -bufsize 10M -profile:v baseline -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 96k %%DESTINATION%%.tmp.mp4",
	  "command2" => "qt-faststart %%DESTINATION%%.tmp.mp4 %%DESTINATION%%.mp4",
	  "command3" => "rm -f %%DESTINATION%%.tmp.mp4",
     ...
     "12" => array(
          ...
          "technical" => "mp4 container, single-pass h264 video main coding, between 800Kbps and 2Mbps, aac audio at 96kbps and 44KHz, 640x360 pixels on 16:9, 25fps",
          "extension" => "mp4",
          "size_43" => "480x360",
          "size_169" => "640x360",
          "cardinality" => "1",
          "command1" => "avconv -y -v info -i %%SOURCE%% -s %%SIZE%% -codec:v libx264 -pix_fmt:v yuv420p -b:v 800k -maxrate:v 2M -bufsize 20M -profile:v main -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 128k %%DESTINATION%%.tmp.mp4",
	  "command2" => "qt-faststart %%DESTINATION%%.tmp.mp4 %%DESTINATION%%.mp4",
	  "command3" => "rm -f %%DESTINATION%%.tmp.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.mp4",
        ),
     ...
     "13" => array(
          ...
          "technical" => "mp4 container, single-pass h264 video main coding, between 2 and 4Mbps, aac audio at 128kbps and 44KHz, 854x480 pixels on 16:9, up to 30fps",
          "extension" => "mp4",
          "size_43" => "640x480",
          "size_169" => "854x480",
          "cardinality" => "1",
          "command1" => "avconv -y -v info -i %%SOURCE%% -s %%SIZE%% -codec:v libx264 -pix_fmt:v yuv420p -b:v 2M -maxrate:v 4M -bufsize 30M -profile:v main -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 128k %%DESTINATION%%.tmp.mp4",
	  "command2" => "qt-faststart %%DESTINATION%%.tmp.mp4 %%DESTINATION%%.mp4",
	  "command3" => "rm -f %%DESTINATION%%.tmp.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.mp4",
        ),
     ...
     "14" => array(
          ...
          "technical" => "mp4 container, single-pass h264 video main coding, between 4 and 8Mbps, aac audio at 192kbps and 44KHz, 1280x720 pixels on 16:9, up to 30fps",
          "extension" => "mp4",
          "recommend" => "1",
          "size_43" => "960x720",
          "size_169" => "1280x720",
          "cardinality" => "1",
          "command1" => "avconv -y -v info -i %%SOURCE%% -s %%SIZE%% -codec:v libx264 -pix_fmt:v yuv420p -b:v 4M -maxrate:v 8M -bufsize 40M -profile:v main -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 192k %%DESTINATION%%.tmp.mp4",
	  "command2" => "qt-faststart %%DESTINATION%%.tmp.mp4 %%DESTINATION%%.mp4",
	  "command3" => "rm -f %%DESTINATION%%.tmp.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.mp4",
        ),
     ...
     "15" => array(
          ...
          "technical" => "mp4 container, single-pass h264 video main coding, between 8 and 12Mbps, aac audio at 192kbps and 44KHz, 1920x1080 pixels on 16:9, up to 30fps",
          "extension" => "mp4",
          "recommend" => "1",
          "size_43" => "1440x1080",
          "size_169" => "1920x1080",
          "cardinality" => "1",
          "command1" => "avconv -y -v info -i %%SOURCE%% -s %%SIZE%% -codec:v libx264 -pix_fmt:v yuv420p -b:v 8M -maxrate:v 12M -bufsize 80M -profile:v main -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 192k %%DESTINATION%%.tmp.mp4",
	  "command2" => "qt-faststart %%DESTINATION%%.tmp.mp4 %%DESTINATION%%.mp4",
	  "command3" => "rm -f %%DESTINATION%%.tmp.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.mp4",
        ),
