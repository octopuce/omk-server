...
$settings=array(
     ...
     "11" => array(
          ...
          "command2" => "avconv -y -v info -i %%SOURCE%% -pass 2 -s %%SIZE%% -codec:v libx264 -b:v 512k -maxrate:v 800k -bufsize 10M -profile:v baseline -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 96k %%DESTINATION%%.mp4",
     ...
     "12" => array(
          ...
          "command2" => "avconv -y -v info -i %%SOURCE%% -pass 2 -s %%SIZE%% -codec:v libx264 -b:v 800k -maxrate:v 2M -bufsize 20M -profile:v main -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 128k %%DESTINATION%%.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.mp4",
        ),
     ...
     "13" => array(
          ...
          "command2" => "avconv -y -v info -i %%SOURCE%% -pass 2 -s %%SIZE%% -codec:v libx264 -b:v 2M -maxrate:v 4M -bufsize 30M -profile:v main -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 128k %%DESTINATION%%.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.mp4",
        ),
     ...
     "14" => array(
          ...
          "command2" => "avconv -y -v info -i %%SOURCE%% -pass 2 -s %%SIZE%% -codec:v libx264 -b:v 4M -maxrate:v 8M -bufsize 40M -profile:v main -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 192k %%DESTINATION%%.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.mp4",
        ),
     ...
     "15" => array(
          ...
          "command2" => "avconv -y -v info -i %%SOURCE%% -pass 2 -s %%SIZE%% -codec:v libx264 -b:v 8M -maxrate:v 12M -bufsize 80M -profile:v main -strict experimental -f mp4 -codec:a aac -ar 44100 -ac 2 -b:a 192k %%DESTINATION%%.mp4",
          "cancelcommand" => "rm %%DESTINATION%%.mp4",
        ),
