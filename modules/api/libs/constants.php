...
/* All the API Errors */
define("API_ERROR_OK",200);
define("API_ERROR_MANDATORY",501);
define("API_ERROR_NOKEY",502);
define("API_ERROR_DISABLED",503);
define("API_ERROR_RATELIMIT",504);
define("API_ERROR_BADPARAM",505);
define("API_ERROR_CREATEMEDIA",506);
define("API_ERROR_ALREADY",507);
define("API_ERROR_NOTPUBLIC",508);
define("API_ERROR_APPNOTALLOWED",509);
define("API_ERROR_CREATEACCOUNT",510);
